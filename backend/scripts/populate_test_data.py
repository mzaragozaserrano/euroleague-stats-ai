    ...
    async with async_session_maker() as session:
        try:
            ...
            players_data = [
                ...
                {"id": 7, "name": "Giannoulis Larkin", "team_id": teams[1].id, "position": "PG"},
                {"id": 8, "name": "Rade Zagorac", "team_id": teams[2].id, "position": "SF"},
            ]
            ...
            games_data = [
                # Temporada 2023 (datos históricos)
                {
                    "id": 1,
                    "season": 2023,
                    "round": 1,
                ...
                # Temporada 2024 (datos recientes)
                {
                    "id": 4,
                    "season": 2024,
                    "round": 1,
                ...
                # Temporada 2025 (actual/en curso)
                {
                    "id": 7,
                    "season": 2025,
                    "round": 1,
            ...
            stats_data = [
                # Temporada 2023 - Partido 1: Real Madrid vs Barcelona
                {
                    "game_id": games[0].id,
                ...
                # Temporada 2023 - Partido 2: Olympiacos vs Panathinaikos
                {
                    "game_id": games[1].id,
                ...
                # Temporada 2024 - Partido 4: Real Madrid vs Barcelona
                {
                    "game_id": games[3].id,
                    "player_id": players[0].id,  # Llull
                    "team_id": teams[0].id,
                ...
                # Temporada 2024 - Partido 5: Olympiacos vs Panathinaikos
                {
                    "game_id": games[4].id,
                    "player_id": players[4].id,  # Sloukas
                    "team_id": teams[2].id,
                ...
                {
                    "game_id": games[4].id,
                    "player_id": players[5].id,  # Printezis
                    "team_id": teams[3].id,
                    "minutes": 30,
                    "points": 20,
                    "rebounds_total": 7,
                ...
                # Temporada 2025 - Partido 7: Real Madrid vs Barcelona
                {
                    "game_id": games[6].id,
                    "player_id": players[0].id,  # Llull
                    "team_id": teams[0].id,
                ...
                # Temporada 2025 - Partido 8: Olympiacos vs Panathinaikos
                {
                    "game_id": games[7].id,
                    "player_id": players[4].id,  # Sloukas
                    "team_id": teams[2].id,
            ...
            logger.info(f"Temporadas incluidas: 2023, 2024, 2025")
