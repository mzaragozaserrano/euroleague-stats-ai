...
**CRITICAL:** 
1. Sanitize the title and body using `.github/docs/windows_utf8_setup.md`.
...
gh pr create --draft --title "<TYPE>: <SANITIZED_TITLE>" --body "Work in progress. Closes #<ISSUE_NUMBER>" --label "$issueLabels";
